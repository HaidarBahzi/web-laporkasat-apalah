...
export default function Page({ params }: { params: { id: string } }) {
  ...
  async function approvePermohonan(role: string) {
    try {
      ...
      router.push("/sekretariat/menu_layanan/permohonan_bantuan");
    } catch (err) {
      console.error(err);
    }
  }
    ...
    <section className="container mx-auto px-24">
      ...
      <MenuBreadCrumbs
        ...
        titleLinkArray={[
          ...
          "/sekretariat/menu_layanan/permohonan_bantuan",
          "/sekretariat/menu_layanan/permohonan_bantuan",
        ]}
      ...
      <MenuContainer>
        <MenuEditTitle
          ...
          linkButton="/sekretariat/menu_layanan/permohonan_bantuan"
        />
