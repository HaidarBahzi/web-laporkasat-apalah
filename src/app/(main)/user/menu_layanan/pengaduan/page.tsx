...
export default function Page() {
  ...
  async function FetchAllData() {
    try {
      ...
      const callAllPengaduan = await GetAllPengaduanBidang(session.idUser!);
  ...
  return (
    <section className="container mx-auto px-16">
      <MenuBreadCrumbs
        ...
        titleLinkArray={["/user/dashboard", "/user/menu_layanan/pengaduan"]}
      ...
      <MenuContainer>
        ...
        <ModalSearchDate
          ...
          onSubmit={async (dateFirst: Date, dateSec: Date) => {
            ...
            const callAllPengaduan = await GetAllPengaduanBidangDate(
              session.idUser!,
              dateFirst,
              dateSec
            );
                      ...
                      <td>
                        <div className={"flex gap-2 justify-center"}>
                          {pelanggaran[value.laporan_id] === 0 ? (
                            <ButtonActionLinkMenu
                              link={`/user/menu_layanan/pengaduan/detaildata/${value.laporan_id}`}
                              btnType={"btn-warning"}
