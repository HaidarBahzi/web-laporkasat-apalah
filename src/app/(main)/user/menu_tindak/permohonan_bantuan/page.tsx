  ...
  return (
    <section className="container mx-auto px-16">
      <MenuBreadCrumbs
        ...
        titleLinkArray={["/user/dashboard", "/user/menu_tindak/permohonan"]}
                ...
                <thead>
                  <tr>
                    ...
                    <th className="font-semibold">
                      ...
                      >
                        BIDANG PENINDAK {getSortIcon("pegawai_nip")}
                      </button>
                    </th>
                    <th className="font-semibold">
                      <button
                      ...
                      <td>
                        <div className={"flex gap-2 justify-center"}>
                          {tindak[value.laporan_id] === 0 ? (
                            <ButtonActionLinkMenu
                              link={`/user/menu_tindak/permohonan_bantuan/detaildata/${value.laporan_id}`}
                              btnType={"btn-warning"}
