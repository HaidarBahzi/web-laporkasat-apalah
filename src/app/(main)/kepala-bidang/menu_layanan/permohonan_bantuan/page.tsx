...
import {
  ...
  GetAllPermohonanKepalaBidang,
  GetAllPermohonanKepalaBidangDate,
...
export default function Page() {
  ...
  async function FetchAllData() {
    try {
      ...
      const callAllPermohonan = await GetAllPermohonanKepalaBidang(
        session.bidangId!
      );
      ...
      <MenuContainer>
        ...
        <ModalSearchDate
          ...
          onSubmit={async (dateFirst: Date, dateSec: Date) => {
            ...
            const callAllPermohonan = await GetAllPermohonanKepalaBidangDate(
              session.bidangId!,
              dateFirst,
              dateSec
            );
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <div className={"flex gap-2 justify-center"}>
                          <ButtonActionLinkMenu
                            link={`/kepala-bidang/menu_layanan/permohonan_bantuan/detaildata/${value.laporan_id}`}
                            btnType={"btn-warning"}
