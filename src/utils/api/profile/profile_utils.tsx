...
export async function UpdateProfile(userKtpSource: string, userKtpNew: string, userNameNew: string, userPhoneNew: string, userAlamatNew: string) {
...
export async function UpdateProfilePassword(userKtpSource: string, userPasswordNew: string) {
    const bcrypt = require("bcrypt")
