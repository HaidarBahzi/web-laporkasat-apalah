...
const LaporanDetailImage: React.FC<LaporanDetailProps> = ({ label, value }) => (
  <View style={styles.sectionimage}>
    <Text>{label}</Text>
    <Text>:</Text>
    <Image src={value} style={styles.imgdetail} />
  </View>
);
...
function LaporanPengaduanDetail(laporan: DataProps) {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View>
          <Text style={styles.bodytitle}>DATA PENGADUAN MASYARAKAT</Text>
          ...
          <Text style={styles.bodysubtitle}>DETAIL PENGADUAN</Text>

          <LaporanDetail label="Judul Pengaduan" value={laporan.judul} />
          <LaporanDetail
...
export default LaporanPengaduanDetail;
