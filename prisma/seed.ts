...
async function main() {
  ...
  const seedBidangPegawai = await prisma.setup_bidang.createMany({
    data: [
      ...
      },
      {
        ...
        bidang_singkatan: "TIBUM",
        created_at: date.toISOString(),
      },
      {
        bidang_nama: "BIDANG PERLINDUNGAN MASYARAKAT DAN PEMADAM KEBAKARAN",
        bidang_singkatan: "LINDAM",
        created_at: date.toISOString(),
      },
      {
        bidang_nama: "KEPALA SATUAN",
        bidang_singkatan: "KASAT",
        created_at: date.toISOString(),
      },
    ],
    skipDuplicates: true,
  ...
  const seedUserPegawai = await prisma.pegawai.createMany({
    data: [
      {
        pegawai_nik: "1234567890123456",
        pegawai_nip: "123456789012345678",
        pegawai_password: passwordHash,
        pegawai_nama: "Hasan Prima",
        pegawai_jk: setup_kelamin.L,
        pegawai_tempat_lahir: "Jl. Ganesha Barat No. 21",
        pegawai_tanggal_lahir: date.toISOString(),
        pegawai_phone: "081226226318",
        pegawai_email: "hasanprima@gmail.com",
        pegawai_alamat: "Jl. Ganesha Barat No. 21",
      ...
      {
        pegawai_nik: "1234567890123455",
        pegawai_nip: "123456789012345677",
        pegawai_password: passwordHash,
        pegawai_nama: "Husain Haidar",
        pegawai_jk: setup_kelamin.L,
        pegawai_tempat_lahir: "Jl. Ganesha Barat No. 1",
        pegawai_tanggal_lahir: date.toISOString(),
        pegawai_phone: "081226226318",
        pegawai_email: "hhaidar@gmail.com",
        pegawai_alamat: "Jl. Ganesha Barat No. 1",
        pegawai_foto: "imagesucok.jpeg",
        pegawai_jabatan: "KEPALA BIDANG",
        agama_id: 1,
        pendidikan_id: 1,
        ...
        pegawai_kewarganegaraan: "WNI",
        pegawai_status: setup_status_aktif.A,
        pegawai_role: setup_role.K,
        bidang_id: 5,

        created_at: date.toISOString(),
      },
      {
        pegawai_nik: "1234567890123450",
        pegawai_nip: "123456789012345670",
        pegawai_password: passwordHash,
        ...
        pegawai_kewarganegaraan: "WNI",
        pegawai_status: setup_status_aktif.A,
        pegawai_role: setup_role.KB,
        bidang_id: 1,

        created_at: date.toISOString(),
      },
      {
        pegawai_nik: "1234567890123452",
        pegawai_nip: "123456789012345671",
        pegawai_password: passwordHash,
        pegawai_nama: "Haidar Bahzi",
        pegawai_jk: setup_kelamin.L,
        pegawai_tempat_lahir: "Jl. Ganesha Barat No. 41",
